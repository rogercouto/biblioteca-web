...
export default function SecoesPage(props: any){
    ...
    function _handleEdit(secao : Secao){
    ...
    async function _handleDelete(secao : Secao){
    ...
    function _renderButtons(secao : Secao){
        if (edtId === 0){
            return (
                <Fragment>
    ...
    function _renderRow(secao : Secao){
        if (secao.id && secao.id > 0 && edtId !== secao.id){
            return(
                <tr key={secao.id}>
                    <td>{secao.nome}</td>
                    <td>{_renderButtons(secao)}</td>
                </tr>
            );
        }else{
            return(
