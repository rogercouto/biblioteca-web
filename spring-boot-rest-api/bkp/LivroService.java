...
public class LivroService {
    ...
    private Exemplar findOrSaveExemplar(Exemplar exemplar){

        return exemplar;
    }

    private void findOrSaveExemplares(Livro livro, List<Exemplar> exemplares){
        if (exemplares != null){
            exemplares.forEach(e -> {
                e.setLivro(livro);
                Exemplar exemplar = findOrSaveExemplar(e);
    ...
    public Livro save(Livro livro){
        ...
        findOrSaveExemplares(livro, exemplares);
        return livro;
    }
}
